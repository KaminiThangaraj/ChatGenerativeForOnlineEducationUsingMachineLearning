...
sys.path.append(r'C:\ffmpeg-5.1\bin')
...
def cut():
    # Load the video
    video = mp.VideoFileClip("C:\\Users\\91936\\OneDrive\\Desktop\\project\\static\\videos\\Python Speech Recognition Tutorial – Full Course for Beginners.mp4")
